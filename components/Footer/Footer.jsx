...
import {fab , faGithub,faLinkedin,faFacebookSquare} from "@fortawesome/free-brands-svg-icons"
...
const Footer = () => {
    return (
        <div  className="aboutMe">
            ...
            <FontAwesomeIcon className="icon" icon={fab,faFacebookSquare} />
            </a>
            <div className="email">
            <FontAwesomeIcon className="icon" icon={fas,faEnvelope} /><p>Shehabakhader@gmail.com</p>
            </div>
            </div>
            </div>
            </div>
