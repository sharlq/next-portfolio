    ...
    <div id="myProjects" className="myProjects">
      {card[0] && (
        <div className="myProjects-projectsGrid">
          <div>
            <p className="myProjects-projectsGrid_title">Projects</p>
            <p className="myProjects-projectsGrid_description">
              Here is a group of my projects to show my abilites and what iam
              capable of doing
            </p>
          </div>
          <CardAnimated
            yourClass="card0"
            cardStyle={{ height: "23.3vh", width: "23.3vw" }}
          >
            <CardContent
          ...
          <CardAnimated
            yourClass="card1"
            cardStyle={{ height: "22vh", width: "22vw" }}
          >
            <CardContent
          ...
          <CardAnimated
            yourClass="card2"
            cardStyle={{ height: "25vh", width: "25vw" }}
          >
            <CardContent
          ...
          <p className="myProjects-projectsGrid_description hideme">
            I have chosen various projects so they show my knowledge in various
            areas
          </p>
          <CardAnimated
            yourClass="card0"
          ...
          <CardAnimated
            yourClass="card2"
            cardStyle={{ height: "25vh", width: "25vw", marginLeft: "1.5vh" }}
          >
            <CardContent
